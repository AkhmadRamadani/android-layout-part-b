package jti.akhmad.ramadani.minggu3partb;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setColor(findViewById(R.id.button_count), mCount % 2 == 0 ? Color.YELLOW : Color.CYAN);
    }
    ...
    public void countUp(View view) {
        ...
        if(mShowCount!=null){
            ...
            setColor(view, mCount % 2 == 0 ? Color.YELLOW : Color.CYAN);
